...
import np.com.sarojghalan.suitcase.dashboard.recyclerview.HomeRecyclerAdapter;
...
public class HomeFragment extends Fragment implements
    ...
    public void onViewCreated(
        ...
        if (loggedInUser != null) {
             welcomeMessage = "Hello " + loggedInUser.fullName;
        } else {
    ...
    private void getProductsFromDb() {
        try {
            SuitcaseDatabase suitcaseDatabase = SuitcaseDatabase.getInstance(
