...
import np.com.sarojghalan.suitcase.utility.BitmapScalar;
...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void startMapActivity() {
        ...
        if(productLocation != null) {
            mapIntent.putExtra("map_lat", productLocation.latitude);
            mapIntent.putExtra("map_long", productLocation.longitude);
        }
    ...
    private void updateProductInDb(
        ...
        try {
            SuitcaseDatabase suitcaseDatabase = SuitcaseDatabase.getInstance(getApplicationContext());
            ProductDao productDao = suitcaseDatabase.getProductDao();
