...
public class MapsActivity extends AppCompatActivity implements
    ...
    public void onMyLocationClick(@NonNull Location location) {
        ...
        locateMarkerToCurrentLocation(new LatLng(location.getLatitude(), location.getLongitude()));
    }
    @Override
    public void onMapClick(@NonNull LatLng latLng) {
        ...
        locateMarkerToCurrentLocation(latLng);
    }
        ...
        if (allPermissionForLocationGranted()) {
            fusedLocationProviderClient.getCurrentLocation(
                ...
                public void onSuccess(Location location) {
                    ...
                    double mapLat =  intent.getDoubleExtra("map_lat", location.getLatitude());
                    double mapLong =  intent.getDoubleExtra("map_long", location.getLongitude());
                    locateMarkerToCurrentLocation(new LatLng(mapLat, mapLong));
                }
    ...
    private void locateMarkerToCurrentLocation(LatLng currentLatLng) {
